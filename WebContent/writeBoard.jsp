...
<%
	BoardDTO dto = control.search();
	int seq = Integer.parseInt(dto.getSeq());
	seq = seq + 1;
%>
<header>
...
<section>
<div>
<h1 style="text-align: center;">공지사항 작성</h1><hr style="width: 100px; margin: 0 auto; margin-top: 30px;">
</div>
<form action="insertBoard.jsp" method="post" name="form">
	<input type="hidden" name="seq" value=<%= seq %> >
	<input type="hidden" name="writer" value=<%= session_id %>>
	<div class="board_title">
	<h3>공지사항 제목</h3>
	<input type="text" name="title" placeholder="공지사항 제목을 입력해주세요.">
	</div>
