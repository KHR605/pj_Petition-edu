...
<!-- End of side -->
<% 
	ArrayList<PetitionDTO> list = (ArrayList<PetitionDTO>)request.getAttribute("dissatisfiedList");
...
<section>
	<article>
	<form action="dissatisfied.fkr" method="post">
...
<div class="contentListWrap">
	<div class="tab">
		<ul>
			<li><a href="satisfied.fkr">성립된 청원</a></li>
			<li style="background-color: rgb(129,169,219);"><a href="dissatisfied.fkr" style="color: white;">미성립된 청원</a></li>
		</ul>
	</div>
	...
	<article class="pageList">
		...
		%>
		<a href="dissatisfied.fkr?page=<%=nowPage-1 %>" style="text-decoration: none;">[Prev]</a>
		<%
			}
		%>
		...
		%>
		<a href="dissatisfied.fkr?page=<%=i %>" style="text-decoration: none;">[<%=i %>]</a>
		<%
				}
			}
			if(nowPage>=maxPage){
		...
		%>
		<a href="dissatisfied.fkr?page=<%=nowPage+1 %>" style="text-decoration: none;">[Next]</a>
		<%
			}
		%>
