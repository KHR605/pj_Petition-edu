...
<!-- End of side -->
<%
	ArrayList<PetitionDTO> list = (ArrayList<PetitionDTO>)request.getAttribute("scrapList");
...
<section>
	<article>
		...
		<nav class="nav_list">
			<ul>
				...
				<li style="font-weight: bold;"><a href='scrapList.fkr'>관심청원 보기</a></li>
	...
	<div class="contentList">
			...
			%>	
				<li>
				<a onclick="return confirm('정말로 해제하시겠습니까?')" href="deleteScrap.fkr?seq=<%=dto.getPetition_seq() %>" style="text-decoration: none; color:red;">
